...
const AboutUs = () => {
  return (
      <section id='about' className=" w-full md:mt-10 text-white font-mullish pb-20 md:pb-32 pt-20 md:pt-32 ">
        <div className=" w-full px-4 md:w-10/12 max-w-[1080px] mx-auto pt-4 ">
          {/* heading */}
          <div className="w-full space-y-2 ">
            <h2 className="text-center font-bold   text-4xl md:text-5xl leading-[1.2]">
          ...
          <div className="max-w-[90rem] bg-richblack-900 border border-slate-600 rounded-2xl mx-auto mt-10 flex relative ">
            <div className="p-6 md:p-10 flex flex-col justify-between ">
              <p className="font-medium text-xl md:text-2xl bg-clip-text bg-gradient-to-b from-neutral-100 to-neutral-300">
              ...
              <div className="flex flex-col md:flex-row p-4 md:p-6 mt-10 justify-center items-center ">
                <div className="Left flex w-full md:w-1/2 ">
                  <ul className="flex flex-col gap-4 text-lg opacity-90">
                    ...
                    <li className="flex  items-center ">
                      <ImCheckboxChecked className="mr-3" />
                      Overcoming challenges with innovative AI solutions
                    </li>
                  </ul>
                </div>
