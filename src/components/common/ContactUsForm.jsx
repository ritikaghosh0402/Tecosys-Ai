    ...
    return (
        <form onSubmit={handleSubmit(submitContactForm)}>
            <div className='flex flex-col w-full sm:w-[500px] gap-5 mx-auto mt-10 '>
                ...
                <button type="submit" className="mt-6 rounded-[8px] bg-[#a36cef] py-[8px] px-[12px]  font-semibold text-lg text-richblack-5 hover:scale-95 transition-all duration-300 ease-in-out"
                disabled={loading}>
                    Send Message
                </button>
